...
public final class SimpleTextReader implements Closeable {
     ...
     * @throws IOException if a porblem occurs while accessing file.
     */
     ...
     * @throws IOException if there is an error while accessing the input stream.
     */
     ...
     * @throws IOException if file does not exist or encoding is not available
     */
     ...
     * {@link IOs#closeSilently} method.
     *
     * @return a new IterableLineReader instance.
     * @throws IOException if file does not exist, or encoding is not supported.
     */
