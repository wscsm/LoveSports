...
public class Files {
     ...
     * @throws IOException if an exception occurs during copy operation.
     */
     ...
     * @throws IOException if there is an error occurs during the read or write of the files
     */
     ...
     * @throws IOException if there is an error during file access.
     */
